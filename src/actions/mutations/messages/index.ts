...
export const isAlreadyHaveChat = ({
  user1Id,
  user2Id,
}: {
  ...
  const isAlreadyHaveChat = useQuery(
    api.chats.chatAlreadyExist,
    user1Id && user2Id ? { chatUsers: [user1Id, user2Id] } : "skip"
  );
  return isAlreadyHaveChat;
};
